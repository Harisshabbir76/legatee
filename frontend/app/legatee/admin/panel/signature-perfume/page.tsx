...
export default async function SignaturePerfumeEditorPage() {
  ...
  return <ShopPageEditorClient pageKey="signature" initialContent={initialContent} initialProducts={products} initialFooterContent={initialFooterContent} />;
}
