    ...
    <div style={{ width: 290, flexShrink: 0, borderLeft: "1px solid #cdbfae", background: "#fff", display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ overflowY: "auto", flex: 1, padding: 16 }}>
        ...
        <button onClick={onUpload} disabled={uploading}
          style={{ width: "100%", padding: "12px 0", background: uploading ? "#e8e0d5" : "#173946", color: uploading ? "#aaa" : "#fff", border: "none", borderRadius: 6, fontSize: 13, fontWeight: 600, cursor: uploading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
        ...
        <div style={{ marginTop: 20, padding: 12, background: "#faf7f1", borderRadius: 6, fontSize: 11, color: "#6f6459", lineHeight: 1.7 }}>
          <strong style={{ color: "#173946" }}>Tip:</strong> After uploading, click <strong>Save Changes</strong> to publish.
        </div>
      </div>
    </div>
  );
