...
import ShopPageEditorClient from "./ShopPageEditorClient";
...
export default async function ShopEditorPage() {
  ...
  return <ShopPageEditorClient pageKey="shop" initialContent={initialContent} initialProducts={products} initialFooterContent={initialFooterContent} />;
}
